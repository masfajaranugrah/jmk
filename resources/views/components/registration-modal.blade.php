...
@endpush
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select 
                                ...
                                :disabled="loadingProvinces"
                                class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm appearance-none bg-white disabled:bg-slate-100 disabled:cursor-wait"
                            >
                            ...
                            <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                                <svg x-show="!loadingProvinces" class="w-4 h-4 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                                <svg x-show="loadingProvinces" class="w-4 h-4 text-blue-500 animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path></svg>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select 
                                ...
                                :disabled="!selectedProvinceId || loadingRegencies"
                                class="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm appearance-none bg-white disabled:bg-slate-100 disabled:cursor-not-allowed"
                            >
                            ...
                            <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                                <svg x-show="!loadingRegencies" class="w-4 h-4 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                                <svg x-show="loadingRegencies" class="w-4 h-4 text-blue-500 animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path></svg>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                                <svg x-show="!loadingDistricts" class="w-4 h-4 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                                <svg x-show="loadingDistricts" class="w-4 h-4 text-blue-500 animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path></svg>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                                <svg x-show="!loadingVillages" class="w-4 h-4 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                                <svg x-show="loadingVillages" class="w-4 h-4 text-blue-500 animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path></svg>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    return {
        ...
        onProvinceChange() {
            ...
            if (this.selectedProvinceId) {
                ...
                this.formData.provinsi = prov ? prov.name : '';
                this.fetchRegencies(this.selectedProvinceId);
            }
        },
        ...
        onRegencyChange() {
            ...
            if (this.selectedRegencyId) {
                const reg = this.regencies.find(r => r.id === this.selectedRegencyId);
                this.formData.kabupaten = reg ? reg.name : '';
                this.fetchDistricts(this.selectedRegencyId);
            }
        },
        ...
        onDistrictChange() {
            ...
            if (this.selectedDistrictId) {
                ...
                this.formData.kecamatan = dist ? dist.name : '';
                this.fetchVillages(this.selectedDistrictId);
            }
        },
        ...
        onVillageChange() {
            ...
            if (this.selectedVillageId) {
                const vil = this.villages.find(v => v.id === this.selectedVillageId);
                this.formData.kelurahan = vil ? vil.name : '';
            }
        },
